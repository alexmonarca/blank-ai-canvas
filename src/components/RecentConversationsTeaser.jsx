      ...
      {open && (
        ...
        >
          ...
          >
            <div className="p-5 border-b border-border flex items-center justify-between gap-3">
              <div className="min-w-0">
                <div className="text-lg font-semibold text-foreground">
                  {hasOmnichannel ? "Painel de Conversas" : "Últimas conversas (preview)"}
                </div>
              ...
              <div className="flex items-center gap-2">
                {hasOmnichannel ? (
                  <button
                    type="button"
                    onClick={() => window.open("https://chat.monarcahub.com", "_blank", "noopener,noreferrer")}
                    className="h-9 px-4 rounded-full border border-border bg-background/40 text-foreground hover:bg-background/60 transition-colors text-xs font-medium"
                  >
                    Abrir em nova aba
                  </button>
                ) : (
            ...
            {hasOmnichannel ? (
              <div className="p-5">
                <div className="h-[72vh] rounded-2xl border border-border bg-background/40 overflow-hidden">
                  <iframe
                    src="https://chat.monarcahub.com"
